...
const Body: any = styled.div<BodyProps>(
...
const Content: any = styled.div<ContentProps>(
...
const Rotate: any = styled.div<RotateProps>(
  ({ degrees }: RotateProps) => `
